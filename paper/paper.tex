...
the return value. There are no mutable data structures in a
probabilistic program, and \texttt{mem}'s memory is stored in a
nested dictionary in the program state (function
\texttt{mem-cps}).  Each memoized function receives a unique
automatically generated identifier. Each time a memoized
