...
one for lunch, one for dinner. We define an Anglican function
...
We are finally ready to define the query. 
...
Performing inference on query \texttt{deli} should predict the
