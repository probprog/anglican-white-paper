...
\texttt{anglican.inference} namespace declares the polymorphic
...
accept multiple parameters as components of a Clojure vector,
in which case the initial value is given as a vector and its
components get bound to the corresponding parameters of the
query (via destructuring).
