...
\lstdefinestyle{default}{language=Anglican,basicstyle=\linespread{0.842}\ttfamily\small, columns=flexible, showstringspaces=false}
}
...
\acmConference[IFL'16]{Implementation and Application of Functional Programming Languages}{August 2016}{Leuven, Belgium}
\acmYear{2016}
\copyrightyear{2017}
...
subsequence of samples. \iftoggle{full}{Many algorithms use an initial
...
\iftoggle{full}{%
\input{case-study-mean-std}
}{}%

\begin{figure}
    \centering
    \includegraphics[trim={6pt 12pt 0 12pt},scale=0.6]{same-customer-time.pdf}
...
\begin{figure}
    \centering
    \includegraphics[trim={6pt 12pt 0 12pt},clip,scale=0.6]{different-customers-times.pdf}
