...
\begin{itemize}
    ...
    \item Semantics of probabilistic forms in Anglican which facilitates full
...
checkpoint and trampoline based interaction between Anglican
program and inference engine does not introduce any noticeable
