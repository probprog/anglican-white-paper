...
as a separate language, rather than being a Clojure library, 
...
answer probabilistic queries on these programs approximately 
often using a large number of samples. As already mentioned,
this execution is significantly different from that of 
usual programs. An Anglican program is executed multiple times, often hundreds
