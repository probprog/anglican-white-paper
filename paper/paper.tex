...
probabilistic programming environment. WebPPL~\cite{GS15} and
Anglican have similar expressivity and capabilities.  WebPPL
runs on top of \href{http://v8project.blogspot.com/}{V8}, a high
performance JavaScript engine featuring a native compiler.
