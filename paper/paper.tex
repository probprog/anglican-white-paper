...
For example, if checkpoint invocations
\begin{lstlisting}[style=default]
    (sample 'C1 ...)
    (sample 'C2 ...) 
    (sample 'C2 ...) 
...
but small disturbances (like removal or addition of a single
checkpoint with a particular identifier) are
unlikely to derail the entire sequence.
