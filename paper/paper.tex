...
\hy{This is a section that should explain the semantics. David's explanation
is based on a state machine that underlies the current implementation.
I think that the section is confusing. I will revise this section.}
