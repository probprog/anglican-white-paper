...
to defining a version of the \texttt{infer} function and 
checkpoint handlers appropriate for the algorithm. The definitions may 
just reuse default implementations or override them
with new algorithm-specific treatment of \texttt{sample} and \texttt{observe} forms 
and inference state.

Let us illustrate this implementation process with
...
(threads executing a program) simultaneously, while LMH re-runs
