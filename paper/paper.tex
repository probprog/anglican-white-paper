...
A good high-level picture is that each inference algorithm specifies a 
virtual machine that executes Anglican programs according to a 
non-standard (often probabilistic) operational semantics. Supporting a wide range 
of inference algorithms and their unusual operational semantics efficiently is the main reason 
that we developed Anglican as a language rather than as a library.
