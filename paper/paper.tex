...
\DeclareFontShape{OT1}{lmtt}{m}{it}
     {<->sub*lmtt/m/sl}{}
\lstdefinestyle{default}{frame=single,language=Anglican, basicstyle=\ttfamily\small, showstringspaces=false}
...
\authorinfo{David Tolpin \and Jan Willem van de Meent \and Frank Wood}{University of Oxford}{dtolpin@robots.ox.ac.uk \and jwvdm@robots.ox.ac.uk \and fwood@robots.ox.ac.uk}
...
\end{itemize}
The CPS transformation of constant \texttt{1} with continutation
