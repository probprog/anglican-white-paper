...
\jw{I'm not sure I understand how PP facilitates simpler implementations that make inference inherently faster.}
...
% evaluate \texttt{sample} and \texttt{observe} checkpoints in an algorithm-specific manner
...
\begin{figure}
    \centering
    \includegraphics[trim={12pt 0 0 0},scale=0.65]{same-customer-time.pdf}
...
\begin{figure}
    \centering
    \includegraphics[trim={12pt 0 0 0},scale=0.65]{different-customers-times.pdf}
