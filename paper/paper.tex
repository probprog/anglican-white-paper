...
recently been an active idea of research~\cite{MMR+07,GMR+08,P09,MWG+10,MSP14,
...
probabilistic programsand distribution defined by the programs is easier in
pure functional setting. Anglican is also implemented as a language without
...
modify program state. \iftoggle{full}{These forms are translated into
