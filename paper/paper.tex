...
(defquery model data
  ...
  (let [;; Guessing a distribution
    ...
    [d a b]))
\end{lstlisting}
This query defines a probability distribution on three
...
control statement at which a thread (also called particle) 
can be either forked or terminated. Similarly, in 
