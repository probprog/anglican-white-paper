...
(defquery model data
  ...
  (let [;; Guessing a distribution
    ...
    [d a b]))
\end{lstlisting}
The query builds a model for the input $\data$, a sequence of data points.
...
first defines so called a prior distribution on these three variables,
and then it adjust this prior distribution based on data points in
