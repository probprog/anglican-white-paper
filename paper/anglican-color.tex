...
\lstset{
  ...
  % clojure declarations
  keywordstyle=[2]\color{purple}\bfseries\small,
  % clojure macros and special forms
  keywordstyle=[3]\color{red}\bfseries\small,
  % clojure functions
  keywordstyle=[4]\color{cyan}\bfseries\small,
  % anglican declarations
  keywordstyle=[5]\color{purple}\bfseries\small,
  % anglican macros
  keywordstyle=[6]\color{red}\bfseries\small,
  % anglican functions
  keywordstyle=[7]\color{cyan}\bfseries\small,
  % anglican inference forms 
  keywordstyle=[8]\color{blue}\bfseries\small
}
